...
class PeopleInfo PROTOBUF_FINAL :
 ...
 public:
  ...
  // repeated .contacts2.PeopleInfo.Phone phone_numbers = 3;
  int phone_numbers_size() const;
  private:
  int _internal_phone_numbers_size() const;
  public:
  void clear_phone_numbers();
  ::contacts2::PeopleInfo_Phone* mutable_phone_numbers(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts2::PeopleInfo_Phone >*
      mutable_phone_numbers();
  private:
  const ::contacts2::PeopleInfo_Phone& _internal_phone_numbers(int index) const;
  ::contacts2::PeopleInfo_Phone* _internal_add_phone_numbers();
  public:
  const ::contacts2::PeopleInfo_Phone& phone_numbers(int index) const;
  ::contacts2::PeopleInfo_Phone* add_phone_numbers();
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts2::PeopleInfo_Phone > phone_numbers_;
...
inline ::contacts2::PeopleInfo_Phone* PeopleInfo::mutable_phone_numbers(int index) {
  // @@protoc_insertion_point(field_mutable:contacts2.PeopleInfo.phone_numbers)
...
PeopleInfo::mutable_phone_numbers() {
  // @@protoc_insertion_point(field_mutable_list:contacts2.PeopleInfo.phone_numbers)
  return &phone_numbers_;
}
inline const ::contacts2::PeopleInfo_Phone& PeopleInfo::_internal_phone_numbers(int index) const {
  return phone_numbers_.Get(index);
}
inline const ::contacts2::PeopleInfo_Phone& PeopleInfo::phone_numbers(int index) const {
  // @@protoc_insertion_point(field_get:contacts2.PeopleInfo.phone_numbers)
  return _internal_phone_numbers(index);
}
inline ::contacts2::PeopleInfo_Phone* PeopleInfo::_internal_add_phone_numbers() {
  return phone_numbers_.Add();
}
inline ::contacts2::PeopleInfo_Phone* PeopleInfo::add_phone_numbers() {
  // @@protoc_insertion_point(field_add:contacts2.PeopleInfo.phone_numbers)
...
PeopleInfo::phone_numbers() const {
  // @@protoc_insertion_point(field_list:contacts2.PeopleInfo.phone_numbers)
  return phone_numbers_;
}
